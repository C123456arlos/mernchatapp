                ...
                <div className="bg-base-300 rounded-xl p-6 space-y-8">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative">
                            <img src={selectedImage || authUser.profilePic || '/avatar.png'} alt="profile" className="size-32 rounded-full object-cover border-4"></img>
                            <label htmlFor="avatar-upload" className={`absolute bottom-0 right-0 bg-base-content hover:scale-105 p-2 rounded-full cursor-pointer transition-all duration-200 ${isUpdatingProfile ? 'animate-pulse pointer-events-none' : ''}`}>
                                ...
                                onChange={handleImageUpload} disabled={isUpdatingProfile}></input>
                            </label>
                        </div>
                        <p className="text-sm text-zinc-400">
                            {isUpdatingProfile ?'uploding':'click the camera icon to update your photo'}
                        </p>
                    </div>
                    <div className="space-y-6">
                        ...
                        <div className="space-y-1.5">
                            <div className="text-sm text-zinc-400 flex items-center gap-2">
                                <Mail className="w-4 h-4"></Mail>email address
                            </div>
