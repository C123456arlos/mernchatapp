    ...
    return (
        <div className='p-4 w-full'>
            {imagePreview && (
                <div className='mb-3 flex items-center gap-2'>
                    <div className='relative'>
                        <img src={imagePreview} alt='preview' className='w-20 h-20 object-cover rounded-lg border border-zinc-700'></img>
            ...
            <form onSubmit={handleSendMessage} className='flex items-center gap-2'>
                ...
                <button type='submit' className='mt-2 btn btn-sm btn-circle' disabled={!text.trim() && !imagePreview}>   <Send size={22}></Send>
                </button>
                </div>
            </form>
    </div>
